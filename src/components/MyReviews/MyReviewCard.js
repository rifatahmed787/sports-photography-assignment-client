...
const MyReviewCard = ({ myReview, handleDelete, refetch }) => {
  ...
  return (
    <div className="card sm:w-1/3 md:w-1/3 lg:1/3 card-width shadow-2xl hover:border-[#057EF9] dark:bg-black border dark:border-white mx-auto mb-16 mt-16">
      {isUpdating === _id ? (
        <div>
        ...
        <div className="card-body">
          <h2 className="card-title  mx-auto">{title}</h2>
          <p className="mx-auto pb-3">{message}</p>
